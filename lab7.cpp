...
int main()
{
	...
	for(;;)
	{
		cout<<"1:Subtract\t2:Dates\tAdd the number of days to a date\nEnter your choice:";
		cin>>choice;
		switch(choice)
		{
			case 1:
				cout<<"Enter the Date1 greater than Date2:";
				d1.getdate();
				d2.getdate();
				i = checkdate(d1,d2);
				if(i==1)
			...
			case 2:
				d3.getdate();
				cout<<endl<<"Enter N of days to add:";
				cin>>no_days;
				cout<<endl<<d3<<"t"<<no_days<<endl;
				d4 = d3+no_days;
				cout<<endl<<d4<<endl;
				break;
			default:
